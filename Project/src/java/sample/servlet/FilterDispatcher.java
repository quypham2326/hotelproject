...
public class FilterDispatcher implements Filter {
    ...
    private final String managerSearchServlet = "ManagerSearchServlet";
    private final String managerShowAllServlet = "ManagerShowAllServlet";
    private final String mangerUpdateServlet = "MangerUpdateServlet";
    private final String staffSearchServlet = "StaffSearchServlet";
    private final String managerReportServlet = "ManagerReportServlet";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (resource.length() > 0) {
                ...
                } else if (resource.equals("staff")) {
                    String action = req.getParameter("btAction");
                    if (action.equals("Filter")) {
                        url = staffSearchServlet;
                    }
                } else if (resource.equals("manager")) {
                    String action = req.getParameter("btAction");
                    if (action.equals("Search")) {
                        url = managerSearchServlet;
                    } else if (action.equals("Update")) {
                        url = mangerUpdateServlet;
                    } else if (action.equals("ShowAll")) {
                        url = managerShowAllServlet;
                    } else if (action.equals("Report")) {
                        url = managerReportServlet;
                    }
                }else if (resource.equals("manager1")){
                     String action = req.getParameter("btAction");
                     url=mangerUpdateServlet;
                     if(action!=null){
                         url=managerReportServlet;
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("FilterDispatcher::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("FilterDispatcher::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("FilterDispatcher::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("FilterDispatcher::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("FilterDispatcher::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
